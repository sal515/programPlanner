...
export class LoginFormComponent implements OnInit {
  ...
  onSubmit() {
    ...
    const netnameChecked = !this.isNetnameMissing(this.loginForm.controls.netname.value);
    const passwordChecked = !this.isPasswordMissing(this.loginForm.controls.password.value);
